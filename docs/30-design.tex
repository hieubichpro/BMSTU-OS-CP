...
\begin{figure}[ph!]
	\center{\includegraphics[scale=0.65]{img/getdents.pdf}}
...
\begin{figure}[ph!]
	\center{\includegraphics[scale=0.65]{img/unlink.pdf}}
...
\begin{figure}[ph!]
	\center{\includegraphics[scale=0.52]{img/rename.pdf}}
...
\begin{figure}[ph!]
	\center{\includegraphics[scale=0.52]{img/readwrite.pdf}}
